...
--Displays the number of crashes in each year 
...
--Displays the number of flights in each year
SELECT *
FROM FlightsByYearPivot

--Shows how many crashes occured compared to the total number of flights
